(function() {
    ...
    '$scope', '$injector', function($scope, $injector) {
		...
		$scope.setupScope = function(formObject) {
			...
			3. Watch scope.label, .fieldid, .placeholder, .required, .options then copy to origin formObject.
			...
			$scope.$watch('[label, fieldid, placeholder, required, options, validation]', function() {
			//$scope.$watch('[label,  placeholder, required, options, validation]', function() {
				formObject.label 				= 	$scope.label;
				formObject.fieldid				= 	$scope.fieldid;
		...
		return $scope.data = {
			...
			rollback: function() {
				...
				$scope.fieldid 				= 	this.model.fieldid;
  ...
  ]).controller('fbFormController', ['$scope', '$injector', function($scope, $injector) {
		var $builder, $timeout;
		$builder = $injector.get('$builder');
  ...
  ]).controller('fbFormObjectController', ['$scope', '$injector', function($scope, $injector) {
		var $builder;
		$builder = $injector.get('$builder');
        ...
        input = {
			...
			fieldid	:	$scope.formObject.fieldid,
...
/*
    component:
        It is like a class.
        The base components are input, textarea, select, check, radio.
        User can custom the form with components.
    formObject:
        It is like an object (an instance of the component).
        User can custom the label, fieldid, required and validation of the input.
    form:
  ...
  angular.module('builder.provider', []).provider('$builder', function() {
    ...
    this.convertComponent = function(name, component) {
		...
		result = {
			...
			fieldid				: 	(_ref2 = component.fieldid) != null ? _ref2 : '',
	...
	this.convertFormObject = function(name, formObject) {
		...
		result = {
			...
			fieldid		: 	(_ref3 = formObject.fieldid) != null ? _ref3 : component.fieldid,
    ...
    this.registerComponent = (function(_this) {
      return function(name, component) {
        ...
        @param component: The component object.
            ...
            fieldid: {string} The fieldid of the input.
    ...
    this.insertFormObject = (function(_this) {
      return function(name, index, formObject) {
        ...
        @param form: The form object.
            ...
            fieldid: {string} The form object fieldid.
